...
export const MODULE_CONTENT: Record<ModuleId, ModuleContent> = {
    ...
    lessons: [
      {
        ...
        details: [
          ...
          "知识截止日期：GPT-5.4 截至 2025.8 / Claude Opus 4.5 可靠知识截止 2025.3",
        ...
        fullContent: [
          ...
          { subtitle: "2. 为什么不同模型\"性格\"不同？", text: "模型的\"性格\"取决于训练数据、微调方式和 RLHF（人类反馈强化学习）。GPT-5.4 偏向全能和实用主义，Claude Opus 4.5 偏向严谨和安全，DeepSeek V3.2 中文理解力强且性价比极高。选择模型就像选择员工——不同岗位用不同的人。" },
          { subtitle: "3. 知识截止日期与实时能力", text: "纯模型推理无法获取最新信息。GPT-5.4 知识截止 2025 年 8 月，Claude Opus 4.5 可靠知识截止 2025 年 3 月。但 GPT-5.4 支持网页搜索和文件搜索，可以弥补这一限制。Claude 同样支持工具调用。这就是为什么 OpenClaw 等框架要给模型\"接手接脚\"——让它能搜索、读文件、浏览网页。" },
      ...
      },
      {
        ...
        fullContent: [
          ...
          { subtitle: "3. 思维链：让 AI \"想清楚再说\"", text: "DeepSeek V3.2 的 deepseek-reasoner 接口原生支持思考模式，会在输出前自动进行多步推理。Claude Opus 4.5 支持\"扩展思维\"（Extended Thinking），可以在回复前进行深度推理。对于数学、逻辑、复杂决策类任务，思考模式的效果远优于普通模式。代价是响应更慢、成本更高。" },
      ...
      },
      {
        ...
        fullContent: [
          { subtitle: "1. 成本的量级变化", text: "以前请一个文案写一篇 1000 字文章：几百到几千元。现在用 Claude Sonnet 4.5（$3/MTok）：1000 字约消耗 2000 tokens，输入+输出总费用不到 $0.01。以前请一个程序员写一个简单功能：几千到几万元。现在用 Cursor Agent：几小时就能完成，API 成本不到 $1。AI 把\"找人做事\"的边际成本从千元级降到了分钱级。" },
          ...
          { subtitle: "3. 一人公司的运营模型", text: "传统一人公司：你一个人做所有事，产出有限。AI 超级个体：OpenClaw 24/7 运行处理日常任务（邮件、客服、监控），DeepSeek V3.2 做低成本分析，Claude Opus 4.5 做深度创作，GPT-5.4 做多模态任务。你只需要做决策和把关。月运营成本：API 费用约 50-200 元。" },
      ...
      },
      {
        ...
        details: [
          "对话：GPT-5.4（1M 上下文，全能）/ Claude Opus 4.5（100 万，推理）/ DeepSeek V3.2（128K，$0.28/MTok）",
        ...
        fullContent: [
          { subtitle: "1. 对话类：按场景选模型", text: "日常问答和简单任务：DeepSeek V3.2（$0.28/MTok，成本最低）。复杂推理和编码：GPT-5.4（$2.50/MTok）或 Claude Opus 4.5（$5/MTok）。长文档分析：Claude Sonnet 4.5（100 万上下文，$3/MTok）或 Kimi K2.5（256K 上下文）。中文场景优先：DeepSeek 或 Kimi。" },
      ...
      },
      {
        ...
        details: [
          ...
          "内容生成：Claude Sonnet 4.5（深度写作）/ GPT-5.4（多模态）",
        ...
        fullContent: [
          ...
          { subtitle: "3. 月运营成本估算", text: "Notion 免费版：$0。OpenClaw：免费开源，部署无成本。DeepSeek V3.2 API（日均 10 万字）：$1-5/月。Claude Sonnet 4.5（每周 2-3 次深度写作）：$5-15/月。GPT-5.4 nano（偶尔多模态任务）：$5-10/月。Cursor 免费版：$0。Perplexity 免费版：$0。总计：$11-30/月。" },
      ...
      },
      {
        ...
        fullContent: [
          { subtitle: "误区 1：把 AI 当实时搜索引擎", text: "大模型有知识截止日期（GPT-5.4 截至 2025.8，Claude Opus 4.5 可靠知识截止 2025.3），对截止日期后的事件一无所知，且可能编造看似合理的答案。纠正方法：需要实时信息时，用 Perplexity 或 GPT-5.4 的网页搜索功能，而不是直接问模型。判断标准：如果你的问题包含\"最新\"、\"现在\"、\"今天\"，就需要搜索工具辅助。" },
          ...
          { subtitle: "误区 3：一个模型用到底", text: "很多人注册了 ChatGPT 就只用 ChatGPT，但不同任务用不同模型，成本和效果差异巨大。日常分析用 DeepSeek V3.2（$0.28/MTok），深度写作用 Claude Sonnet 4.5（$3/MTok），复杂推理用 Claude Opus 4.5（$5/MTok）。如果全部用 Claude Opus 4.5，月成本可能是 DeepSeek 的 18 倍。纠正方法：建立\"任务-模型\"对照表，按任务复杂度选模型。" },
      ...
      },
      {
        ...
        details: [
          "Day 1：注册 DeepSeek（chat.deepseek.com 网页版）和 Kimi（kimi.moonshot.cn），直接体验对话，无需配置",
          ...
          "Day 5：了解 OpenClaw（openclaw.ai），阅读官方文档，评估是否适合你的场景",
        ...
        fullContent: [
          ...
          { subtitle: "Day 5-6：搭建自动化", text: "第五天安装 OpenClaw，访问 openclaw.ai 下载安装包。配置 DeepSeek API Key（platform.deepseek.com 获取），完成基础对话测试。不要急着做复杂的事，先确保基础功能正常。第六天创建第一个 Skill。推荐从\"每日邮件摘要\"开始：设置触发时间（每天早上 9 点），读取收件箱，按重要程度分类，生成摘要推送到你的 Telegram。这是最有实感的自动化场景。" },
  ...
  "llm": {
    ...
    keyTakeaways: [
      ...
      "Claude Opus 4.5：200K 上下文（扩展模式 1M），$5/MTok 输入，扩展思维与自适应思维",
    ...
    lessons: [
      {
        ...
        details: [
          "GPT-5.4：1M 上下文，输入 $2.50/MTok，输出 $20/MTok，最大 128K 输出",
          "GPT-5.4 mini：400K 上下文，输入 $0.75/MTok，输出 $4.50/MTok",
          "Claude Opus 4.5：200K 上下文（扩展模式 1M），输入 $5/MTok，输出 $25/MTok，最大 64K 输出",
          "Claude Sonnet 4.5：100 万上下文，输入 $3/MTok，输出 $15/MTok",
        ...
        fullContent: [
          ...
          { subtitle: "2. Claude Opus 4.5（来源：platform.claude.com/docs）", text: "Anthropic 旗舰模型。200K tokens 上下文窗口（扩展模式支持 1M），64K 最大输出，可靠知识截止 2025 年 3 月。支持扩展思维（Extended Thinking）和自适应思维（Adaptive Thinking），在复杂推理和编码任务上表现卓越。Claude Sonnet 4.5 是性价比之选，200K 上下文（1M beta），输入 $3/MTok。Claude Haiku 4.5 最快最便宜，200K 上下文，输入 $1/MTok。" },
      ...
      },
      {
        ...
        details: [
          ...
          "超长文本：Claude Sonnet 4.5（1M beta）/ GPT-5.4（1M）> Kimi K2.5（256K）> Claude Opus 4.5（200K）",
          "复杂推理：Claude Opus 4.5（扩展思维）> GPT-5.4 > DeepSeek reasoner（思考模式）",
          "编码开发：GPT-5.4 > Claude Opus 4.5 > Kimi K2.5（Agent Coding 能力）",
        ...
        fullContent: [
          ...
          { subtitle: "2. 质量优先：Claude Opus 4.5", text: "对于需要深度推理、长文档分析、复杂编码的任务，Claude Opus 4.5 是最佳选择。100 万上下文 + 扩展思维模式，可以处理超大型代码库和复杂逻辑。价格较高（$5/MTok 输入），建议仅在复杂任务中使用。" },
          { subtitle: "3. 均衡之选：GPT-5.4 / Claude Sonnet 4.5", text: "GPT-5.4 是全能型选手，支持函数调用、网页搜索、文件搜索、计算机使用。Claude Sonnet 4.5 在推理质量和速度之间取得最佳平衡，100 万上下文仅 $3/MTok。日常使用推荐 Sonnet 4.5，复杂任务切换到 Opus 4.5。" },
      ...
      },
      {
        ...
        fullContent: [
          ...
          { subtitle: "2. Anthropic API", text: "访问 console.anthropic.com 注册。Claude API 支持 AWS Bedrock 和 Google Vertex AI，适合有云服务需求的用户。Claude Opus 4.5 推荐作为复杂推理任务的默认模型。" },
          ...
          { subtitle: "4. OpenClaw 配置", text: "OpenClaw 内置支持 Opus 4.5、GLM-5、KIMI K2.5、GPT-5.2 Codex、Gemini 3 Pro 五种旗舰模型。也支持自定义 API 端点和 Ollama 本地模型。配置流程：打开 OpenClaw 设置 → 填入 API Key → 选择模型 → 测试对话。推荐先用 DeepSeek 测试，成本低、上手快。" }
        ]
      },
      {
  ...
  "openclaw": {
    ...
    icon: Cpu,
    color: "emerald",
    description: "OpenClaw 是一款开源的个人 AI 助手与自主代理，本地部署保障数据隐私，支持 WhatsApp/Telegram/Discord/Slack/Signal/iMessage 全渠道接入，通过 Skills 技能系统实现邮件、文件、浏览器等自动化。（数据来源：openclaw.ai）",
    keyTakeaways: [
      "本地运行，数据主权：所有对话历史、偏好、文件均保留在本地，不上传第三方",
      "全渠道接入：WhatsApp / Telegram / Discord / Slack / Signal / iMessage",
      "内置 5 种旗舰模型：Opus 4.5 / GLM-5 / KIMI K2.5 / GPT-5.2 Codex / Gemini 3 Pro",
    ...
    lessons: [
      {
        title: "OpenClaw 架构与核心能力（来源：openclaw.ai 官方文档）",
        ...
        details: [
          ...
          "多模型支持：内置 Opus 4.5 / GLM-5 / KIMI K2.5 / GPT-5.2 Codex / Gemini 3 Pro",
        ...
        fullContent: [
          ...
          { subtitle: "3. 内置模型与订阅服务", text: "OpenClaw 内置支持 5 种旗舰模型：Opus 4.5、GLM-5、KIMI K2.5、GPT-5.2 Codex、Gemini 3 Pro。也提供\"内置 API 年费\"和\"Plus 年费\"两种订阅计划，包含专属 Gateway 实例和月度 API 额度，支持微信支付。订阅后无需自行配置 API Key，开箱即用。" }
        ]
      },
      {
      ...
      },
      {
        ...
        fullContent: [
          { subtitle: "1. 推荐安装方式", text: "对于非技术用户，推荐使用官方一键安装脚本。访问 openclaw.ai 下载对应平台的安装包，按图形界面引导完成安装。安装完成后，首次启动会引导你配置模型和聊天渠道。如果你已有 DeepSeek API Key（推荐，性价比高），直接填入即可。" },
          { subtitle: "2. 订阅服务方案", text: "如果你不想自己管理 API Key，OpenClaw 提供订阅服务。\"内置 API 年费\"计划包含专属 Gateway 实例和月度 API 额度，支持微信支付。订阅后所有内置模型（Opus 4.5 / GLM-5 / KIMI K2.5 等）均可直接使用。" },
  ...
  "scenarios": {
    ...
    sections: [
      { title: "内容创作者", content: "GPT-5.4 选题研究 + Claude Sonnet 4.5 深度写作 + Sora 2 视频生成 + OpenClaw 定时发布。", icon: Video },
    ...
    lessons: [
      {
        ...
        details: [
          ...
          "深度写作：Claude Sonnet 4.5（100 万上下文），可同时参考多篇长文档写作",
        ...
        fullContent: [
          ...
          { subtitle: "2. 深度写作（Claude Sonnet 4.5 官方能力）", text: "Claude Sonnet 4.5 提供 100 万 tokens 上下文窗口，输入 $3/MTok。你可以同时喂给它 10+ 篇参考文章、竞品分析报告、用户评论数据，让它基于全面的信息进行深度写作。适合长文、深度分析、技术教程等需要高质量输出的场景。" },
      ...
      },
      {
        ...
        details: [
          ...
          "商品内容生成：GPT Image 1.5 生成商品图 + Claude Sonnet 4.5 撰写详情页",
        ...
        fullContent: [
          ...
          { subtitle: "2. 商品内容批量生成", text: "方案：GPT Image 1.5 + Claude Sonnet 4.5。用 Claude Sonnet 4.5 的 100 万上下文窗口，同时参考 10+ 个竞品详情页和用户评价，生成差异化的商品描述。再用 GPT Image 1.5 生成商品主图和场景图。成本估算：每个商品详情页约消耗 3000 tokens 输入 + 1500 tokens 输出，费用约 $0.01。" },
    ...
    lessons: [
      {
        ...
        fullContent: [
          ...
          { subtitle: "3. 各工具的免费额度", text: "DeepSeek（platform.deepseek.com）：新用户赠金，deepseek-chat 接口免费额度。Kimi（platform.moonshot.cn）：按 Token 计费，但提供免费试用额度。Claude（claude.ai）：网页版免费使用，有每日消息限制。ChatGPT（chatgpt.com）：基础版免费。OpenClaw（openclaw.ai）：完全免费开源。" }
        ]
      },
      {
      ...
      },
      {
        ...
        content: "AI 行业进化速度极快。GPT-5.4 的知识截止是 2025 年 8 月，Claude Opus 4.5 的训练数据截止 2026 年 1 月。你需要持续跟进官方更新。",
        ...
        details: [
          ...
          "OpenClaw 官方网站：openclaw.ai — 新 Skills、新功能",
          "Cursor 更新日志：cursor.com — 新功能、Agent 能力提升"
        ],
        fullContent: [
          { subtitle: "1. 模型进化速度", text: "以 OpenAI 为例：从 GPT-4o 到 GPT-5.4，上下文窗口从 128K 扩展到 1M，新增了网页搜索、文件搜索、计算机使用等能力。Anthropic 的 Claude 从 Sonnet 3.5 到 Opus 4.5，增加了扩展思维和自适应思维。DeepSeek V3.2 的思考模式提供了低成本深度推理。这些变化意味着你半年前的工作流可能已经可以大幅优化。" },
