...
const FAQ_DATA = [
  { q: "我完全零基础，能学吗？", a: "完全可以。我为零基础同学专门设计了阶段 0，课程会优先给出免费或低成本路径，你只需要跟着步骤完成真实任务。不需要编程基础，也不需要英语基础。" },
  { q: "需要花多少钱？", a: "你可以先从免费额度和低成本工具开始。我的建议是阶段 0 尽量先不付费；进入高频使用后，再根据任务量决定是否订阅或接入 API。不同工具的免费额度和价格变化很快，使用前以官方当前页面为准。" },
  { q: "和其他 AI 课程有什么区别？", a: "我更重视方法、边界和执行节奏，而不是堆砌热点名词。我会带你回到官方文档或公开原始来源，我的案例也会强调前置条件和风险，不把个案包装成普遍结果。" },
  { q: "学完能赚钱吗？", a: "我不承诺任何收入。在我的案例库中，所有数据都标注了来源和风险提示。对我而言，AI 是工具，不是印钞机。你的收入最终取决于你的行业知识、执行力和市场判断。" },
  { q: "我不是程序员，也能学这些内容吗？", a: "可以。公开学习路径优先面向资料整理、写作、研究、会议和项目推进等日常工作，不要求编程基础。先从「入门」和「ChatGPT」开始，带着一个真实小任务练习即可。" },
  { q: "内容多久更新一次？", a: "我会持续整理和更新内容，但对于价格、版本、上下文窗口这类变化很快的信息，我仍建议你在使用前点开官方页面再确认一次。我在模块页保留了整理日期和核心参考来源。" },
  { q: "ChatGPT 和 WorkBuddy 应该先学哪个？", a: "如果你还不确定怎样把需求说清、怎样使用资料并核验结果，先学「ChatGPT」。如果你已经能稳定产出初稿，想把资料整理、会议纪要、任务拆解和复盘连成工作流程，再学「WorkBuddy」。两者都从低风险、可检查的任务开始。" },
