...
const FAQ_DATA = [
  ...
  { q: "OpenClaw / Claude Code 选哪个？", a: "这两个工具并不冲突，建议根据当前的具体需求来选择。如果你需要本地部署、多渠道接入（如飞书/微信）和长期自动化任务，OpenClaw 更合适；如果你更侧重代码开发、文档协作和快速任务迭代，Claude Code 效率更高。可以先学习「OpenClaw」或「AI 编程」模块，跑通一个最小闭环。" },
